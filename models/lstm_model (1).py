...
class CrowdLSTM(nn.Module):
    def __init__(self, input_size=3, hidden_layer_size=256, num_layers=3):
...
class CrowdLSTMModel:
    ...
    def __init__(self, sequence_length=60, epochs=150, lr=0.001):
    ...
    def load(self, paths=('models/lstm_weights.pth', 'models/scaler.pkl')):
        ...
        import sys
        sys.modules['src.ml.lstm_model'] = sys.modules[__name__]
