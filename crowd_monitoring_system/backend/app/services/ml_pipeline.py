...
class MLPipeline:
    def __init__(self):
        ...
        self.csv_path = "storage/processed/processed_crowd_data.csv"
    ...
    def train_model(self):
        ...
        try:
            ...
            if len(df) < 15:
                # Add synthetic data if entirely empty but still required (fallback case)
                return {"status": "error", "message": "Not enough data to train models"}
