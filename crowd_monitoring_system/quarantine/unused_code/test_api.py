...
def test_predict_endpoint():
    with patch("backend.app.main.get_predictions") as mock_pred:
...
def test_predict_risk_endpoint():
    with patch("backend.app.main.get_predictive_risk") as mock_risk:
...
def test_train_endpoint():
    with patch("backend.app.main.train_system") as mock_train:
...
def test_live_density_endpoint():
    with patch("backend.app.main.process_image") as mock_proc, \
         patch("backend.app.main.generate_alert") as mock_alert:
...
def test_test_email_alert_endpoint():
    with patch("backend.app.main.generate_alert") as mock_alert:
