import pytest
from backend.app.services.alert import generate_alert, predict_future_risk
from backend.app.core.threshold import get_risk_level
...
def test_alert_email_exception_handling():
    with patch("backend.app.services.alert._send_high_alert_email") as mock_send:
...
def test_send_high_alert_email_logic():
    from backend.app.services.alert import _send_high_alert_email
    ...
    with patch("os.getenv") as mock_env:
        ...
        with patch("smtplib.SMTP") as mock_smtp:
            ...
            with patch("backend.app.services.alert._last_high_alert_ts_by_zone", {}):
