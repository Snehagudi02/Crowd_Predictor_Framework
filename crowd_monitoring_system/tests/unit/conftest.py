...
2.  Before the test runs, the real processed_crowd_data.csv is backed up to a temp file.
...
REAL_CSV = "storage/processed/processed_crowd_data.csv"


@pytest.fixture(autouse=True)
def isolate_dataset():
    """
    Backs up the real processed_crowd_data.csv before each test and restores it after.
    ...
    if backup_path and os.path.exists(backup_path):
        shutil.copy2(backup_path, REAL_CSV)   
